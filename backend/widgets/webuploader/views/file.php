    ...
    <div class="file-list clearfix">
        <div class="form-group" data-name ="<?= $name; ?>" data-boxId ="<?= $boxId; ?>">
            <div class="col-sm-12 input-group">
                <input id="file-default-<?= $boxId; ?>" type="text" class="form-control" placeholder="请选择文件进行上传" value="<?php if (!empty($value)) {
    echo '已选择' . count($value) . '个文件';
} ?>" disabled>
